...
(function () {
  ...
  el.innerHTML = [
    ...
    '        <img src="images/app-icon.png" alt="Finiverse" width="36" height="36" style="border-radius:10px;object-fit:cover">',
    ...
    '        <span data-en="App Store" data-es="App Store">App Store</span>',
    '      </a>',
    '    </div>',
    ...
    '    <span data-en="© 2026 Finiverse · BeGoTech. Made with ♥ for every mind." data-es="© 2026 Finiverse · BeGoTech. Hecho con ♥ para toda mente.">© 2026 Finiverse · BeGoTech. Made with ♥ for every mind.</span>',
