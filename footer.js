...
(function () {
  ...
  el.innerHTML = [
    ...
    '        </a>',
    '        <a href="https://facebook.com/hello.finiverse" class="footer-social-link" target="_blank" rel="noopener" aria-label="Facebook">',
    ...
    '        </a>',
    '        <a href="mailto:hello@finiverseapp.com" class="footer-social-link" aria-label="Email">',
